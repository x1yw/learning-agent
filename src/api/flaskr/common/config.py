...
Default: "phone".""",
    ...
    "TOKUI_IMAGE_API_BASE_URL": EnvVar(
        name="TOKUI_IMAGE_API_BASE_URL",
        default="",
        description="OpenAI-compatible image generation API base URL for TokUI teacher media.",
        group="integrations",
    ),
    "TOKUI_IMAGE_API_KEY": EnvVar(
        name="TOKUI_IMAGE_API_KEY",
        default="",
        description="API key for TokUI teacher image generation.",
        secret=True,
        group="integrations",
    ),
    "TOKUI_IMAGE_MODEL": EnvVar(
        name="TOKUI_IMAGE_MODEL",
        default="gpt-image-2",
        description="Image generation model name for TokUI teacher media.",
        group="integrations",
    ),
    "TOKUI_IMAGE_TIMEOUT_SECONDS": EnvVar(
        name="TOKUI_IMAGE_TIMEOUT_SECONDS",
        default=120,
        type=int,
        description="Timeout in seconds for TokUI image generation provider calls.",
        group="integrations",
    ),
    "TOKUI_IMAGE_SIZE": EnvVar(
        name="TOKUI_IMAGE_SIZE",
        default="1024x1024",
        description="Default image size sent to the TokUI image generation provider.",
        group="integrations",
    ),
    "TOKUI_IMAGE_DEFAULT_CANDIDATE_COUNT": EnvVar(
        name="TOKUI_IMAGE_DEFAULT_CANDIDATE_COUNT",
        default=3,
        type=int,
        description="Default number of TokUI image candidates generated per teacher request.",
        group="integrations",
    ),
    "TOKUI_IMAGE_PROMPT_OPTIMIZER_ENABLED": EnvVar(
        name="TOKUI_IMAGE_PROMPT_OPTIMIZER_ENABLED",
        default=True,
        type=bool,
        description="Whether TokUI image jobs must optimize teacher prompts before provider calls.",
        group="integrations",
    ),
    "TOKUI_IMAGE_PROMPT_OPTIMIZER_MODEL": EnvVar(
        name="TOKUI_IMAGE_PROMPT_OPTIMIZER_MODEL",
        default="",
        description="LLM model used to optimize teacher image prompts for TokUI image jobs.",
        group="integrations",
    ),
    "TOKUI_IMAGE_PROMPT_OPTIMIZER_TEMPERATURE": EnvVar(
        name="TOKUI_IMAGE_PROMPT_OPTIMIZER_TEMPERATURE",
        default=0.2,
        type=float,
        description="Temperature for TokUI image prompt optimization.",
        group="integrations",
    ),
    "TOKUI_IMAGE_PROMPT_OPTIMIZER_SYSTEM_PROMPT": EnvVar(
        name="TOKUI_IMAGE_PROMPT_OPTIMIZER_SYSTEM_PROMPT",
        default="",
        description="System prompt/template used to optimize teacher image prompts.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_ENABLED": EnvVar(
        name="LEARNER_ASK_IMAGE_ENABLED",
        default=False,
        type=bool,
        description="Enable asynchronous image generation for learner follow-up asks.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_REUSE_ENABLED": EnvVar(
        name="LEARNER_ASK_IMAGE_REUSE_ENABLED",
        default=True,
        type=bool,
        description="Reuse eligible course image assets before generating learner ask images.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_AUTO_REUSE_PENDING": EnvVar(
        name="LEARNER_ASK_IMAGE_AUTO_REUSE_PENDING",
        default=False,
        type=bool,
        description="Allow ready learner-generated images pending teacher review to be reused.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_MAX_PER_USER_PER_DAY": EnvVar(
        name="LEARNER_ASK_IMAGE_MAX_PER_USER_PER_DAY",
        default=10,
        type=int,
        description="Daily learner ask image generation limit per user.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_MAX_PER_COURSE_PER_DAY": EnvVar(
        name="LEARNER_ASK_IMAGE_MAX_PER_COURSE_PER_DAY",
        default=100,
        type=int,
        description="Daily learner ask image generation limit per course.",
        group="integrations",
    ),
    "LEARNER_ASK_IMAGE_MATCH_THRESHOLD": EnvVar(
        name="LEARNER_ASK_IMAGE_MATCH_THRESHOLD",
        default=0.92,
        type=float,
        description="Similarity threshold reserved for learner ask image reuse matching.",
        group="integrations",
    ),
